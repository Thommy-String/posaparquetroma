                    ...
                    <div className="flex gap-2 w-full">
                        ...
                        <button 
                            ...
                            className="
                                ...
                                hover:shadow-[0_12px_28px_rgba(16,185,129,0.24)]
                        ...
                        >
                            {/* Icona WhatsApp */}
                            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-600 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.18)]">
                            ...
                            <span className="flex min-w-0 flex-col items-start leading-none">
                                ...
                                <span className="text-[9px] font-semibold text-emerald-800/80 normal-case">Preventivo gratis</span>
                            </span>
                        </button>
                        ...
                        <button 
                            ...
                            className="
                                ...
                                font-bold 
                                transition-all duration-200 
                                shadow-[0_10px_24px_rgba(59,130,246,0.18)]
                                hover:shadow-[0_12px_28px_rgba(59,130,246,0.24)]
                                hover:-translate-y-0.5
                                active:bg-blue-100
                                text-left
                            "
                        >
                            {/* Icona Telefono */}
                            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.18)]">
                            ...
                            <span className="flex min-w-0 flex-col items-start leading-none">
                                ...
                                <span className="text-[9px] font-semibold text-blue-800/80 normal-case">07:00 - 20:00</span>
                            </span>
                        </button>
